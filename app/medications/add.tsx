...
export default function AddMedicationScreen() {
  ...
  const [timeIndex, setTimeIndex] = useState(0); // Initialize to 0 (first time)
  ...
  useEffect(() => {
    handleFrequencyChange(form.frequency);
    console.log(frequency);
  }, [form.frequency, handleFrequencyChange]);
    ...
    return (
      <View style={styles.optionsGrid}>
        ...
        <Text style={{ color: "gray" }}>
          No reminders will be sent if you choose As Needed
        </Text>
      </View>
    );
  };
  ...
  return (
    <View style={styles.container}>
      <StatusBar backgroundColor={"#146922"} />
      {/*  */}
      <LinearGradient
          ...
          <View style={styles.container}>
            ...
            {form.frequency && form.frequency !== "As needed" && (
              <View style={styles.timesContainer}>
                <Text style={styles.timesTitle}>Medication Time(s)</Text>
                {form.times.map((time, index) => (
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      ...
                      setTimeIndex(index); // Set the index here!
                    }}
                  >
            ...
            {showTimePicker && (
              <DateTimePicker
                value={(() => {
                  const [hours, minutes] = form.times[timeIndex]
                    .split(":")
                    .map(Number); // Use timeIndex
                  const date = new Date();
